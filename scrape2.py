...
for j in map(lambda x: x[:x.index('index.html')]+"map.html", diseaseLinks):
    try:
        driver.get(j)
        print(driver.find_elements(By.XPATH, '//table[thead/tr/th/text()="States"]/tbody/tr/td/text()'))
        print(driver.find_elements(By.XPATH, '//table[thead/tr/th/text()="State"]/tbody/tr/td/text()'))
        print(driver.find_elements(By.XPATH, '//table[thead/tr/td/text()="State"]/tbody/tr/td/text()')) 
    except:
        pass